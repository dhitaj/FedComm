...
def get_weight_parameter(old_average, target_average, nr_averaging_participants):
    malicious_parameter = target_average*nr_averaging_participants - (nr_averaging_participants-1)*old_average
    return malicious_parameter
